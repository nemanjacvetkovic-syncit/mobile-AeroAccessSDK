...
class BeaconPoint: Object, Codable {
    ...
    convenience init(uuid_mobile: UUID? = nil, language: String? = nil, host: String? = nil, platform: String? = nil, manufacturer: String? = nil, model: String? = nil, os: String? = nil, latitude_x: String? = nil, longitude_y: String? = nil, timestamp: String? = nil) {
        self.init()
